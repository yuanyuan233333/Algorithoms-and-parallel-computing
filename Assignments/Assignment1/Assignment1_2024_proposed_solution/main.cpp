...
int main() {
    ...
    else if (filename == "../inputs/input_large.txt"){
        max_expected = 49.9822;
        min_expected = 0.00670684;
        closest_expected = 2.02611;
    }
    else if (filename == "../inputs/input_small.txt"){
        max_expected = 3.26311;
        min_expected = 0.0739875;
        closest_expected = 3.26311;
    }
